...
def calculate_budget(
    ...
    # Total non-main size
    non_main_bytes = (
        main_audio_bytes + main_subtitle_bytes +
        extras_video_bytes + extras_audio_bytes + extras_subtitle_bytes +
        menu_video_bytes + menu_audio_bytes + menu_subtitle_bytes +
        overhead_bytes
    )
    ...
    return {
        ...
        "subtitle_size_mb": (main_subtitle_bytes + extras_subtitle_bytes + menu_subtitle_bytes) / (1024 ** 2),
